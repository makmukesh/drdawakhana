...
public class HomeDashboard_old_Activity extends AppCompatActivity {

    public static String TAG = "HomeDashboard_old_Activity";
    ...
    Activity act = HomeDashboard_old_Activity.this;
    ...
    public void LoadNavigationHeaderItems() {
        ...
        profileImage.setBackground(getResources().getDrawable(R.drawable.ic_icon_user));
...
//
//                    startActivity(new Intent(HomeDashboard_Activity.this, Inbox_Activity.class).putExtra("ComesFrom","Home"));
//                    if (drawer.isDrawerOpen(GravityCompat.START)) {
//                        drawer.closeDrawer(GravityCompat.START);
//                    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelectProductByCategory, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
...
//                            Toast.makeText(HomeDashboard_Activity.this, "API Response", Toast.LENGTH_SHORT).show();
...
//          Toast.makeText(this, "API Response", Toast.LENGTH_SHORT).show();
            ...
            for (int i = 0; i < AppController.categoryList.size(); i++) {
                if (AppController.categoryList.get(i).get("HID").equalsIgnoreCase("1"))
                    executeToGetFruitListRequest();
                else if (AppController.categoryList.get(i).get("HID").equalsIgnoreCase("2"))
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            postParameters.add(new BasicNameValuePair("MobileNo", AppController.getSpIsInstall().getString(SPUtils.USER_MobileNo, "")));
                            postParameters.add(new BasicNameValuePair("DeviceID", "" + FirebaseInstanceId.getInstance().getToken()));
