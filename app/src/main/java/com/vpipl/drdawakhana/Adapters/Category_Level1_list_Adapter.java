...
public class Category_Level1_list_Adapter extends RecyclerView.Adapter<Category_Level1_list_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_List;
    LayoutInflater inflater = null;
    Context context;

    public Category_Level1_list_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_List = list;
          ...
          //  AppUtils.loadProductImage(context , array_List.get(position).get("imgPath") , holder.imageView_product);
            ...
            holder.ll_main.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, CategoryLevel2ListActivity.class);
