...
public class Category_Home_Main_list_Adapter extends RecyclerView.Adapter<Category_Home_Main_list_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_List;
    LayoutInflater inflater = null;
    Context context;

    public Category_Home_Main_list_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_List = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(inflater.inflate(R.layout.adapter_category_home_list, parent, false));
    }
