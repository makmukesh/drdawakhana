...
import com.vpipl.drdawakhana.Adapters.Category_Level2_list_Adapter;
...
public class CategoryLevel2ListActivity extends Activity {
    private String TAG = "CategoryLevel2ListActivity";
    ...
    public Category_Level2_list_Adapter cate_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.activity_category_level2_list);

            act = CategoryLevel2ListActivity.this;
            ...
            heading.setText("" + getIntent().getStringExtra("SubCategory"));
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            postParameters.add(new BasicNameValuePair("SubcategoryID", "" + getIntent().getStringExtra("SCID")));
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodtoMenusLevel_2_Subcategory, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
    ...
    private void getAllActivityListResult(JSONArray jsonArray) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                map.put("SubCategory", jsonObject.getString("SubCat"));
    ...
    private void showListView() {
        try {
            if (array_list.size() > 0) {
                cate_adapter = new Category_Level2_list_Adapter(act, array_list);
    ...
    private void executeFilterationRequest() {
        new AsyncTask<Void, Void, String>() {
            protected void onPreExecute() {
                AppUtils.showProgressDialog(CategoryLevel2ListActivity.this);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (getIntent().getExtras().getString("Type").equalsIgnoreCase("C")) {
                        ...
                        Categorycode = getIntent().getExtras().getString("categoryID");
                        Level1CategoryId = getIntent().getExtras().getString("SCID");
                        Level2CategoryId = "0";
                    ...
                    response = AppUtils.callWebServiceWithMultiParam(CategoryLevel2ListActivity.this, postParameters, QueryUtils.methodToSelectProductByCategory, TAG);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return response;
    ...
    private void saveProductsListNew(final JSONArray jsonArrayProductList) {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(CategoryLevel2ListActivity.this);
        }
    }
    private void setGridViewData() {
        try {
            ...
            adapter = new ProductListGrid_Adapter(CategoryLevel2ListActivity.this, productList ,"Grid");
            ...
            gridView_products.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(CategoryLevel2ListActivity.this, ProductDetail_Activity.class);
                    ...
                    if (scrollState == SCROLL_STATE_IDLE) {
                        if (gridView_products.getLastVisiblePosition() >= count - threshold) {
                            if (NoofProduct != productList.size()) {
                                if (AppUtils.isNetworkAvailable(CategoryLevel2ListActivity.this)) {
                                    isLoadMore = true;
//                                    pageIndex++;
                                    NumOfRows = NumOfRows + 16;
                                    // executeToGetProductLoadMoreListRequest();
                                } else {
                                    AppUtils.alertDialog(CategoryLevel2ListActivity.this, getResources().getString(R.string.txt_networkAlert));
                                }
                            }
                        }
                    }
